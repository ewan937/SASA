                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="plan" id="plan" required>
                        ...
                        <option value="40 MBPS">40mbp</option>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumernotfinish_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_datedisconnected" class="col-sm-3 control-label">Datedisconnected</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_datedisconnected" name="datedisconnected">
                    </div>
                </div>

                <div class="form-group">
                    <label for="edit_datereconnected" class="col-sm-3 control-label">Datereconnected</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_datereconnected" name="datereconnected">
                    </div>
                </div>
