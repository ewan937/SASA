    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumercable_add.php" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="status" id="status" required>
                        ...
                        <option value="DISCONNECTED CHANGE TO INTERNET">DISCONNECTED CHANGE TO INTERNET</option>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumercabledisco_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="date" class="form-control" id="datepicker_edit" name="dateinstalled">
                      </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" id="datepicker_edit1" name="datedisconnected" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" id="datepicker_edit2" name="datereconnected">
                    </div>
                </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumercabledisco_delete.php">
            		<input type="hidden" class="cosid" name="id">
