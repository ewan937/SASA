...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumercable_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="date">
                      <input type="date" class="form-control" id="datepicker_edit1" name="datedisconnected">
                    </div>
                </div>
                </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="costumercable_delete.php">
            		<input type="hidden" class="cosid" name="id">
